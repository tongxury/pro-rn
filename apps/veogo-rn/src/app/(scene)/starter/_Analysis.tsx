...
function Component({
    ...
    const [promptId, setPromptId] = useState<string>("analysis");
    ...
    const onExtracted = (resources: Resource[]) => {
        ...
        // const metas = resources?.filter((x) => !isMedia(x));

        setResources(resources);
        setPromptId(videos?.length ? "analysis" : "analysisImages");
    };
