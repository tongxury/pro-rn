...
function Component({
    ...
    const [promptId, setPromptId] = useState<string>("preAnalysis");
    ...
    const onFilesChange = (files: Resource[]) => {
        ...
        setPromptId(videos?.length ? "contentGeneration" : "contentGenerationImages");
    };
        ...
        <TouchableOpacity activeOpacity={1} onPress={() => Keyboard.dismiss()} className={'flex-1 px-5'}>
            <View className="flex-1">
                ...
                <Text
                    ...
                    {t("scene.contentGenerationTitle")}
                </Text>
