                    ...
                    if (resource.addComponent) {
                        ...
                        return (
                            <TouchableOpacity onPress={pickFromGallery}>
                                <View
                                    className="w-[150px] h-[180px] rounded-[10px] flex-row items-center p-[10px] gap-2 justify-center border-dashed border border-grey0 overflow-hidden"
                                    ...
                                    {isProcessing ? (
                                        ...
                                        <>
                                            <MaterialIcons
                                                ...
                                                color="#666"
                                            />
                                            <Text className="text-grey2 text-sm" numberOfLines={1}>
